            ...
            return `
                  <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="card border border-gray-100">
                            <div class="card-body">
                                <a href="course-details.html?id=${formation.id}" class="bg-main-100 rounded-8 overflow-hidden text-center flex-center">
                                ...
                                <div class="p-8">
                                    ...
                                    <h5 class="mb-0"><a href="course-details.html?id=${formation.id}" class="hover-text-main-600">${formation.name}</a></h5>

                                    <div class="mt-10">
                                      <p>${formation.description}</p>
                                    </div>
                                                          
                                    <a href="course-details.html?id=${formation.id}" class="btn btn-outline-main rounded-pill py-9 w-100 mt-24">Detail formation</a>
                                </div>
                            </div>
                        </div>
                    </div>
